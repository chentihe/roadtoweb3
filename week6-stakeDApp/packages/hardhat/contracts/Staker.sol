...
contract Staker {
  ...
  */
  ...
  function withdraw() public withdrawalDeadlineReached(true) claimDeadlineReached(false) {
    ...
    uint256 indBalanceRewards = (individualBalance + rewardRatePerBlock)**(block.number - depositBlockNumber[msg.sender]);
  ...
  */
  ...
  function redeposit() public {
    exampleExternalContract.redeposit(address(this));
  }
